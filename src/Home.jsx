...
function Home() {
  ...
  // whever we click on the button it will take all prev value three dots is also called as array destructuring
  const Click = () =>{
      setData((oldenItems) => {
 ...
 // it targets on the id as it will be different for different items with on clicking method
  const deleteItems = (id) => { 
   ...
   return (
    <>
    <div className="bg-gray-500 text-black-700 text-4xl p-2 antialised text-end  flex">
